...
/**
 *	Test class for ShowActivity. All the UI tests are written here. Robotium test framework is used
 */
...
public class ShowActivityTest {
    ...
    /**
     * Add a city to the listview and check city name using assertTrue
    ...
    /**
     * Closes the activity after each case
     * @throws Exception
     */
    @After
